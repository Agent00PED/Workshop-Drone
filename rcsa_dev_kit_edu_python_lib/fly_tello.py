...
class FlyTello:
    ...
    #
    def bounce(self, dist: int,times: int, tello: Union[int, str]='All', sync: bool=True) -> None:

        verticalSpeed = 60.0
        bounceDelay = dist/verticalSpeed

        for i in range(times):
            self._command_with_value('up', 'Control', dist, 20, 500, 'cm', tello, sync)
            time.sleep(bounceDelay)
            self._command_with_value('down', 'Control', dist, 20, 500, 'cm', tello, sync)
            time.sleep(bounceDelay)

    def bouncedown(self, dist: int,times: int, tello: Union[int, str]='All', sync: bool=True) -> None:
    ...
    def get_height(self, tello: Union[str, int]='All', sync: bool=False) -> None:
        """ Read the Serial Number of the Tello(s) """
        self._command('height?', 'Read', tello, sync)

    def get_temperature(self, tello: Union[str, int]='All', sync: bool=False) -> None:
        """ Read the Serial Number of the Tello(s) """
        self._command('temp?', 'Read', tello, sync)

    def get_attitude(self, tello: Union[str, int]='All', sync: bool=False) -> None:
        """ Read the Serial Number of the Tello(s) """
        self._command('attitude?', 'Read', tello, sync)

    def get_barometer(self, tello: Union[str, int]='All', sync: bool=False) -> None:
        """ Read the Serial Number of the Tello(s) """
        self._command('baro?', 'Read', tello, sync)

    def get_distance_tof(self, tello: Union[str, int]='All', sync: bool=False) -> None:
        """ Read the Serial Number of the Tello(s) """
        self._command('tof?', 'Read', tello, sync)

    def get_acceleration(self, tello: Union[str, int]='All', sync: bool=False) -> None:
        """ Read the Serial Number of the Tello(s) """
        self._command('acceleration?', 'Read', tello, sync)
